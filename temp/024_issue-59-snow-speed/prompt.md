...
- App lazy fallback と本物 Loader の二段構えを廃止し、loading 中は開始から終了まで同じ Loader マークアップに統一
...
- 冬切り替え時にエラーが出ないことを確認
- `main.tsx` から `React.lazy` と中間 fallback を削除
- `rg "boot-loader|lazy\\(" src/main.tsx src/index.css src/App.tsx` で中間 loading が消えていることを確認
