...
import { loadBottleJournal, type BottleJournalEntry } from "@/utils/bottleJournal";
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              {showInlineAmbientHint && (
                <InlineAmbientHint text={uiHintText} isMobile={isMobile} />
              )}
          ...
          {isJournalOpen && (
            <BottleJournalPanel entries={journalEntries} isMobile={isMobile} />
          )}
        </div>
      ...
      {showFloatingUiHint && (
        <FloatingUiHint text={uiHintText} isMobile={isMobile} />
      )}
      ...
      <UxHintOverlay
        ...
        isMobile={isMobile}
        showHints={showHints}
        showWaterHint={showWaterHint}
        onDismissHints={onDismissHints}
        onReopenHints={onReopenHints}
      />
    </>
  );
};
