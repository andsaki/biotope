...
// パーティクルの数
export const SNOW_COUNT = 280;

// 初期位置の範囲
export const SNOW_SPAWN_X_RANGE = 30;
export const SNOW_SPAWN_Y_RANGE = 10;
export const SNOW_SPAWN_Y_OFFSET = 3;
...
export const SNOW_RESET_Y_BASE = 10;
export const SNOW_RESET_Y_RANGE = 4;
export const SNOW_RESET_Z_RANGE = 30;

// マテリアル設定
export const SNOW_SIZE = 0.22;
export const SNOW_COLOR = "#EAF6FF";
export const SNOW_OPACITY = 0.92;
